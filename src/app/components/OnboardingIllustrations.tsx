...
/* ══════════════════════════════════════════
   STEP 1: Visa type — Portal logo + glassmorphism person + E-9 card
   Logo smaller (left), person emphasized (right)
   ══════════════════════════════════════════ */
export function Step1Illustration() {
  return (
    ...
    >
      ...
      {/* Person figure + E-9 card — RIGHT, emphasized */}
      <motion.div
        animate={float(0.5, 3.5)}
        className="relative"
        style={{ zIndex: 1 }}
      >
        {/* Person — larger, glassmorphism */}
        <div
          style={{
            display: "flex",
        ...
        >
          ...
          <div
            style={{
              ...
              borderRadius: 18,
              background:
                "linear-gradient(135deg, rgba(99,91,255,0.45), rgba(59,130,246,0.4))",
          ...
          <div
            style={{
              ...
              background:
                "linear-gradient(135deg, rgba(99,91,255,0.4), rgba(59,130,246,0.35))",
              backdropFilter: "blur(8px)",
        ...
        {/* E-9 visa card — floating beside person */}
        <motion.div
          animate={float(1, 3)}
          style={{
            position: "absolute",
            ...
            boxShadow:
              "inset 0 1px 1px rgba(255,255,255,0.3), 0 6px 14px rgba(99,102,241,0.22)",
          }}
        >
          <span
            style={{
...
/* ══════════════════════════════════════════
   STEP 2: Nationality — 3D Globe with detailed continents + red pins
   Globe body stays still, continents rotate inside
   ══════════════════════════════════════════ */
    ...
    >
      ...
      <div
        style={{
          ...
          bottom: "calc(50% - 65px)",
          background:
            "linear-gradient(135deg, rgba(147,197,253,0.4) 0%, rgba(191,219,254,0.2) 100%)",
          borderRadius: 8,
      ...
      {/* Globe — body does NOT rotate, continents inside DO */}
      <motion.div animate={float(0, 5)} style={{ position: "relative", zIndex: 2 }}>
        <div
          style={{
            ...
            borderRadius: 50,
            background:
              "linear-gradient(135deg, #93c5fd 0%, #3b82f6 40%, #2563eb 70%, #1d4ed8 100%)",
            boxShadow:
              "inset -10px -6px 20px rgba(0,0,0,0.12), inset 6px 6px 16px rgba(255,255,255,0.2), 0 10px 28px rgba(59,130,246,0.22)",
            position: "relative",
            overflow: "hidden",
          }}
        >
          {/* Continents — rotating inside */}
          <div
            style={{
              position: "absolute",
              inset: 0,
              animation: "continentSpin 30s linear infinite",
            }}
          >
            {/* Asia / East */}
            <div
        ...
        {/* 5 Red pins — appear L→R sequentially */}
        {[
          { top: -6, left: 12 },
          { top: 8, left: 78 },
          { top: 42, left: -8 },
...
/* ══════════════════════════════════════════
   STEP 3: Basic info — Person with ID card + Hourglass
   ══════════════════════════════════════════ */
export function Step3Illustration() {
  return (
    ...
    >
      ...
      {/* Person with ID card */}
      <motion.div animate={float(0, 4)} className="relative">
        <div
          style={{
            display: "flex",
            flexDirection: "column",
        ...
        >
          <div
            style={{
              ...
              borderRadius: 15,
              background:
                "linear-gradient(135deg, rgba(16,185,129,0.45), rgba(52,211,153,0.4))",
              backdropFilter: "blur(8px)",
              border: "1px solid rgba(255,255,255,0.3)",
          ...
          <div
            style={{
              ...
              borderRadius: "14px 14px 18px 18px",
              background:
                "linear-gradient(135deg, rgba(16,185,129,0.4), rgba(52,211,153,0.3))",
              backdropFilter: "blur(8px)",
              border: "1px solid rgba(255,255,255,0.25)",
              marginTop: -4,
      ...
      {/* Hourglass */}
      <motion.div animate={float(0.6, 3.5)}>
          ...
          <div style={{ position: "relative", height: 40, overflow: "hidden" }}>
            <div
              style={{
                ...
                borderTop: "20px solid rgba(99,91,255,0.12)",
              }}
            />
            <div
              style={{
                ...
                borderLeft: "18px solid transparent",
                borderRight: "18px solid transparent",
                borderBottom: "20px solid rgba(99,91,255,0.12)",
              }}
            />
            {/* Sand particles */}
            {[0, 1, 2].map((i) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: 2,
                  background: "#F59E0B",
                  animation: `sandFall 2s ease-in ${i * 0.6}s infinite`,
                }}
              />
            ))}
          </div>
...
/* ══════════════════════════════════════════
   ...
   Complex Korean doc → Phivis → Clean translated doc
   ══════════════════════════════════════════ */
export function Step4Illustration() {
  return (
    ...
    >
        ...
        {[22, 18, 20, 16, 22, 14, 20, 18, 16, 22].map((w, i) => (
          <div
            ...
            style={{
              ...
              height: 2,
              borderRadius: 1,
              background: "rgba(107,114,148,0.3)",
            }}
          />
        ))}
      </motion.div>

      {/* Transformation arrow with glow */}
      <motion.div
        ...
        style={{
          ...
          alignItems: "center",
          justifyContent: "center",
          boxShadow: "0 0 16px rgba(99,91,255,0.2)",
          flexShrink: 0,
        }}
      >
      ...
      {/* Translated document — clear, organized */}
      <motion.div
...
/* ══════════════════════════════════════════
   STEP 5: Optional info — 3D Phone + Coins + Currency symbols
   ══════════════════════════════════════════ */
      ...
      <motion.div animate={float(0, 3)}>
        <div
          style={{
            ...
            justifyContent: "center",
            boxShadow:
              "inset 0 1px 1px rgba(255,255,255,0.3), inset 0 -1px 1px rgba(0,0,0,0.05), 0 10px 24px rgba(99,102,241,0.2)",
          }}
        >
          <div
            style={{
            ...
            style={{
              ...
              background:
                i === 0
                  ...
                  : `linear-gradient(135deg, rgba(245,158,11,${0.7 - i * 0.15}), rgba(251,191,36,${0.6 - i * 0.15}))`,
              marginTop: i > 0 ? -4 : 0,
              boxShadow:
                i === 0
                  ? "inset 0 1px 2px rgba(255,255,255,0.4), 0 6px 14px rgba(245,158,11,0.22)"
